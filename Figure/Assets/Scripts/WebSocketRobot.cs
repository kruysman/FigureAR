	...
	IEnumerator Start () {
		...
		while (true)
		{
			...
			if (reply != null)
			{
				...
				Debug.Log ("trajectory: "+trajectory.ToString());
				...
				Debug.Log ("PoseString" + trajectory.table_t_robot.position.x.ToString());
				if (trajectory.table_t_robot.position.x.ToString() != "") {
					...
					//Quaternion robot_orientation = new Quaternion (trajectory.table_t_robot.orientation.x, trajectory.table_t_robot.orientation.y, trajectory.table_t_robot.orientation.z, trajectory.table_t_robot.orientation.w); 
					eulerConversion = new Vector3 (0, 0, 90f);
					//robot.transform.localRotation = robot_orientation;
				...
				/*
				clip_robot.SetCurve("/agilus_FK/agilus_A1_GEO", typeof(Transform), "rotation.y", curve_A1);
				clip_robot.SetCurve("/agilus_FK/agilus_A1_GEO/agilus_A2_GEO", typeof(Transform), "rotation.z", curve_A2);
				clip_robot.SetCurve("/agilus_FK/agilus_A1_GEO/agilus_A2_GEO/agilus_A3_GEO", typeof(Transform), "rotation.z", curve_A3);
				clip_robot.SetCurve("/agilus_FK/agilus_A1_GEO/agilus_A2_GEO/agilus_A3_GEO/agilus_A4_GEO", typeof(Transform), "rotation.x", curve_A4);
				clip_robot.SetCurve("/agilus_FK/agilus_A1_GEO/agilus_A2_GEO/agilus_A3_GEO/agilus_A4_GEO/agilus_A5_GEO", typeof(Transform), "rotation.z", curve_A5);
				clip_robot.SetCurve("/agilus_FK/agilus_A1_GEO/agilus_A2_GEO/agilus_A3_GEO/agilus_A4_GEO/agilus_A5_GEO/agilus_A6_GEO", typeof(Transform), "rotation.x", curve_A6);
